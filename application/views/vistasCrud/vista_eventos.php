          ...
          <div class="row">
            ...
            <div style="display: flex; flex-wrap: wrap; ;" class="col-lg-5 mb-lg-0 pb-lg-3 mb-4">
              ...
              <div style = "text-align: center;" class="card">
                <button >Evento 1</button>
                <button>Evento 2</button>
                <button>Evento 3</button>
                <button>Evento 4</button>
                <button>Evento 5</button>
                <button>Evento 6</button>
                <button>Evento 7</button>
                <button>Evento 8</button>
                </div>
            </div>
