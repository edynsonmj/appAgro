      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form class="form-inline" action="/action_page.php">
            ...
            <input type="email" class="form-control mb-2 mr-sm-2" placeholder="Nombre evento" id="email">
            <label for="pwd" class="mr-sm-2">Ubicacion</label>
            <input type="password" class="form-control mb-2 mr-sm-2" placeholder="Ubicacion" id="pwd">
...
<div class="card-body">
  <div id="table" class="table-editable">
    ...
    <table class="table table-bordered table-responsive-md table-striped text-center">
      ...
      <tbody>
        <tr>
          <td class="pt-3-half" contenteditable="true">AgroFeria</td>
          <td class="pt-3-half" contenteditable="true">Calle 43 # 3-4</td>
          <td class="pt-3-half">
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <form class="form-inline" action="/action_page.php">
                        <label for="email" class="mr-sm-2">Nombre del Evento:</label>
                        <input type="email" class="form-control mb-2 mr-sm-2" placeholder="Nombre del evento"
                          id="email">
                        <label for="pwd" class="mr-sm-2">Ubicacion</label>
                        <input type="password" class="form-control mb-2 mr-sm-2" placeholder="Nueva ubicacion" id="pwd">
  ...
  <tr>
    <td class="pt-3-half" contenteditable="true">Feria Agricola</td>
    <td class="pt-3-half" contenteditable="true">calle 4#6-34 Popayan</td>
    <td class="pt-3-half">
      <span class="table-up"><a href="#!" class="indigo-text"><i class="fas fa-long-arrow-alt-up"
            aria-hidden="true"></i></a></span>
      <span class="table-down"><a href="#!" class="indigo-text"><i class="fas fa-long-arrow-alt-down"
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form class="form-inline" action="/action_page.php">
                  ...
                  <label for="pwd" class="mr-sm-2">Ubicacion del evento</label>
                  <input type="password" class="form-control mb-2 mr-sm-2" placeholder="Nueva ubicacion" id="pwd">
...
<tr>
  <td class="pt-3-half" contenteditable="true">Remates Agro</td>
  <td class="pt-3-half" contenteditable="true">carrera 9#5-52</td>
  <td class="pt-3-half">
    <span class="table-up"><a href="#!" class="indigo-text"><i class="fas fa-long-arrow-alt-up"
          aria-hidden="true"></i></a></span>
    <span class="table-down"><a href="#!" class="indigo-text"><i class="fas fa-long-arrow-alt-down"
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-inline" action="/action_page.php">
                <label for="email" class="mr-sm-2">Nombre del evento</label>
                <input type="email" class="form-control mb-2 mr-sm-2" placeholder="Nombre del evento" id="email">
                <label for="pwd" class="mr-sm-2">Ubicacion</label>
                <input type="password" class="form-control mb-2 mr-sm-2" placeholder="Nueva ubicacion" id="pwd">
                <button type="submit" class="btn btn-primary mb-2">Actualizar</button>
              </form>
