...
<div class="card">
  ...
  <h5 class="card-header font-weight-bold text-uppercase py-4">
  ...
  <div class="card-body">
    <div id="table" class="table-editable">
          ...
          <?php if (count($compras) > 0) : ?>
            ...
            <?php foreach ($compras as $compra) : ?>
              ...
              <tr>
                ...
                <td class="pt-3-half" contenteditable="false"><?php echo $compra[1]->getDescuento(); ?></td>
                <td class="pt-3-half" contenteditable="false"><?php echo $compra[1]->getTotal(); ?></td>
                <td>
                  <span class="table-remove">
                    <form method="POST" action="<?php echo base_url(); ?>index.php/GestionCarrito/deleteItemCarrito">
                      ...
                      <button type="submit" class="btn btn-danger btn-rounded btn-sm my-0"> Eliminar</button>
                    </form>
                  </span>
                </td>
              </tr>
            <?php endforeach; ?>
            <tr>
              <h4><?php echo "Total a pagar: " . $miTotal; ?></h4>
            </tr>
          <?php else : ?>
            <td>
              no hap elementos
      ...
      <span class="table-remove">
        <form class="p-2" method="POST" action="<?php echo base_url(); ?>index.php/GestionCarrito/deleteCarrito">
          <input name="usuario" type="hidden" value=<?php echo $usuario; ?>>
          <button type="submit" class="btn btn-danger btn-rounded btn-sm my-0"> Eliminar Carrito</button>
        </form>
      </span>
    </div>
  </div>
